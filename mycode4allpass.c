...
{
	if (! MyInitThreadsCalled) {
		Printf ("MyCreateThread: Must call InitThreads first\n");
		Exit ();
	}
	int newThread;
		int i;
...
{
	if (! MyInitThreadsCalled) {
		Printf ("MyYieldThread: Must call InitThreads first\n");
		Exit ();
	}
...
{
	if (! MyInitThreadsCalled) {
		Printf ("MySchedThread: Must call InitThreads first\n");
		Exit ();
	}
...
{
	if (! MyInitThreadsCalled) {
		Printf ("MyExitThread: Must call InitThreads first\n");
		Exit ();
	}
